...
import SelfEmployedPerson from './entities/self-employed.js';
import BuisnessLicensePerson from './entities/BuisnessLicencePerson.js';
...
const designer = new BuisnessLicensePerson({
    id: '15169845878',
    name: 'Plunksytė',
    surname: 'Krupštytė',
});
...
const marketingSpecialist = new BuisnessLicensePerson({
    id: '15169845878',
    name: 'Protenis',
